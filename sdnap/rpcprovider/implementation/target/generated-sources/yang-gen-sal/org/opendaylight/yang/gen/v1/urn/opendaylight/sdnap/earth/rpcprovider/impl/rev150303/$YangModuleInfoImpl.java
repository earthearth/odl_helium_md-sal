...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "earth-rpcprovider-impl";
    private final String namespace = "urn:opendaylight:sdnap:earth:rpcprovider-impl";
    private final String revision = "2015-03-03";
    private final String resourcePath = "/META-INF/yang/earth-rpcprovider-impl.yang";

...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "earth-rpcprovider";
    private final String namespace = "urn:opendaylight:sdnap:rpcprovider";
    private final String revision = "2015-03-01";
    private final String resourcePath = "/META-INF/yang/earth-rpcprovider.yang";
